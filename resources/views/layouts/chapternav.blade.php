...
<body>
    <div id="mySidenav" class="sidenav">
        ...
        {{-- <h5>Teacher</h5> --}}
        <a href="{{route('studentChapterHome')}}"><button class="{{(\Request::route()->getName() == 'studentChapterHome')  ? 'sidenav-active-link' : '' }}"><i class=" fa fa-line-chart"></i>
            Add Event</button></a>
...
<body>
    <div id="main">
        <div class="fof">
                <h1>Error 401</h1>
        <h3>Access Denied</h3>
        <h5>Only Student Chapters can access this page</h5>
