...
>>>>>>> 09383834b291ec202d1918661f3ebc0b831311ee
    ...
    <div class="flexArea" id="flexArea">
        <div class="navbar">
            <div class="openbtnhide"><a href="javascipt:void(0)"></a><i class="fa fa-bars fa-lg " onclick="toggleF()"></i>
                </a></div>
            <div>
            ...
            <ul id="usernav">
                ...
                <a style="padding-left:1rem " href="{{ route('logout') }}" onclick="event.preventDefault();
...
<body>
    <div id="main">
        <div class="fof">
            ...
            <a style="padding-left:1rem;text-decoration:none;font-size:1.2rem;color:#222; " href="{{ route('logout') }}" onclick="event.preventDefault();
                    document.getElementById('logout-form').submit();">
                {{ __('Logout') }}
            </a>
