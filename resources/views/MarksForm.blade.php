...
<h2 style="margin: 1% 2.5% 1% 2.5%;">Add Marks</h2>

<!-- <div style=""> -->
    <form method="POST"  id="studentIdsform" action="/marksForm">
        @csrf
...
<div>
    ...
    <div>
        <div class="dropdown">
            {{-- <input type="text" name="marksInput"  class="dropinput" style="outline: none;" placeholder="Marks"> --}}
...
<div class="cardRow2 tablecard">
    ...
    <table class="attendance_form_table">
        ...
        <tbody id="attendance_form_table_data">
            ...
            <tr>
            <td><input type="checkbox" class="attcheck" name="" id="" style="display: none"></td>
                <td>{{$student->rollNo}}</td>
            <td>{{$student->fname}} {{$student->lname}}</td>
            <td><input type="text" name="marksInput{{$student->UID}}" id="marksInput{{$student->UID}}" class="dropinput" style="outline: none;" placeholder="Marks"></td>
...
<script>
    ...
    function getSelected(){
        var checkbox=document.getElementsByClassName('dropinput');
        var checkedList=[]
        for(var i=0;i<checkbox.length;i++){
            checkedList.push(checkbox[i].value?checkbox[i].value:0);
        }
