    ...
    <div class="flexContainer" id="dashboardLineContainer">
        <div class="flex-40 dashboardLine">
            ...
            <div style="margin-bottom: 0;margin-top: 0;">
                <h3 style="margin-bottom: 0;margin-top: 2px;"><small>Student Chapter Dashboard</small> </h3>
                <p style="margin-bottom: 0;margin-top: 0;"><small>Events</small> </p>
            </div>
        ...
        <div class="flex-40-end">
            <ul class="breadcrumb" style="float: right;">
                ...
                <li><small>Student Chapter</small></li>
            </ul>
        </div>
    </div>
</div>

<h2 style="margin: 1% 2.5% 1% 2.5%;">Add Events</h2>

<!-- <div style=""> -->
    <form method="POST"  id="studentIdsform" action="/studentChapter">
        @csrf
...
<div>
    ...
    {{-- <div>
        ...
        <input type="text" name="link" placeholder="Form Link" class="formInput">
        <input type="text" name="price" placeholder="Price" class="formInput">
  
    <div>
        <div class="dropdown">
            <input type="date" name="date" id="attDate" class="dropinput" style="outline: none;">
